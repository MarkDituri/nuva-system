            ...
            <div class="col-xl-10 cont-gral">
                ...
                <div class="row">
                    ...
                    <div class="col-12 cont-tit">
                        ...
                        if($acceso == "master"){                        
                        ?>
                            <h1><i class="fas fa-user-friends"></i> <b>Miembros</b></h1> <a class="btn-panel" href="cuenta-nueva.php"><i class="i-bla fas fa-plus"></i> Nuevo usuario</a>
                        <?php
                        } else {
                        ?>
                    ...
                    <?php 
                        ...
                        if(isset($_GET["ver_dat"])){
                            ...
                            if($ver_dat == "si"){
                                ...
                                echo        "<h4><i class='fas fa-check-circle'></i> Usuario creado</h4>";
                                echo        "<p>Un nuevo usuario ah sido creado con Exito!";
                                echo        "</p>";
                                echo    "</div>";
                                echo "</div>";
                            } else if ($ver_dat == "no"){
